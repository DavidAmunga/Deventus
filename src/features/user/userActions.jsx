...
export const goingToEvent = event => async (
  ...
  try {
    ...
    console.log(error);
    toastr.error("Oops", "Problem signing up to events");
  }
};
...
export const cancelGoingToEvent = event => async (
  ...
  try {
    ...
    toastr.success(`Success`, `You have removed yourself from the events`);
  } catch (error) {
    console.log(error);
...
export const followUser = userToFollow => async (
  ...
  const user = firestore.auth().currentUser;
  const following = {
    photoUrl: userToFollow.photoURL || "/assets/images/user.png",
